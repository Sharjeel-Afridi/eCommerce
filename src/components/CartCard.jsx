        ...
        <div className="flex justify-between bg-white w-[45vw] m-4 text-[1rem] border-b-[0.667px] py-[24px] px-[8px] border-gray-200">
            <div className="flex">
                <div className="w-[13vw]">
                    <img src={apiResponse.items[0].image} />
                </div>
                <div className="flex flex-col pl-5 pb-2 font-light text-gray-500">
                    <h1 className="font-medium text-black">{apiResponse.items[0].name}</h1>
                    <h3>Mens Shoes</h3>
            ...
            <h3 className="pl-10 font-medium">MRP: ${apiResponse.items[0].price}</h3>
        </div>
    )
};
